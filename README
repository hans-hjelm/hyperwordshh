## hyperwordshh
This is a fork of hyperwords (https://bitbucket.org/omerlevy/hyperwords - see original README below) that I need in my other projects.
The main change is added support for n-graph representations of word spaces, similar to what Facebook's fastText uses. Other main
differences for now:

* Added setup.py to simplify installing.
* Adapted (most of) the code to run under python3.
* Changed the text normalization to be able to handle Unicode, not just ascii (important for non-English text).
